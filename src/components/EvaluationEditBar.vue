<template>
  <template v-if="showBar">
    <v-card
      class="evaluation-edit-bar rounded-0"
      elevation="0"
    >
    ...
    <div
      class="evaluation-edit-bar-spacer"
      aria-hidden="true"
    />
  </template>
</template>
